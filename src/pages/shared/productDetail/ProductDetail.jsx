...
const ProductDetail = () => {
  ...
  const { product_name, description, product_image, external_Link, _id, upVote, downVote, tag_input } = service;
  return (
    <>
      <Container>
            ...
            <div className='lg:flex lg:items-center'>
              ...
              <div className='w-full space-y-12 lg:w-1/2  '>
                ...
                <div>
                  ...
                  <ul className="flex gap-3"><span className="uppercase text-[#415161] font-bold">Tags:</span>
                    {
