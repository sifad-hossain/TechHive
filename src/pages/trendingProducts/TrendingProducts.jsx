...
const TrendingProducts = () => {
    ...
    return (
        <>
            <Container>
                <SectionTitle
                    heading={"Discover the hottest and most popular tech innovations, driven by user engagement and upvotes."}
                    subHeading={"Trending Section"}>
                </SectionTitle>
                <div className="grid grid-cols-3  mt-10 -z-10">
                    {
                        product.filter(p => p.upVote.length).slice(0, 6)?.map(tech =>
